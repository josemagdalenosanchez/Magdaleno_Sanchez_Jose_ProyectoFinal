...
<body>
    <div id="general">
        ...
        <div id="opciones">
            <div id="tareas"><img src="../imagenes/martillo.jpg" width="100px" height="100px"><a href='Tareas-ADMIN.php' class="boton">Gestion de Tareas</a></div>
            ...
            <div id="usuarios"><img src="../imagenes/usuario.png" width="100px" height="100px"><a href='Usuarios-ADMIN.php' class="boton">Gestion de Usuarios</a></div>
        </div>
    </div>
</body>
</html>
